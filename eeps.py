...
USAGE:
  pypy3 eeps.py -i ../path/to/logs/of/#cs-york -d freenode-dedups.txt -o cs-york-eeps.json
'''
...
if __name__ == "__main__":
  ...
  eeps_all_time = defaultdict(int)
  # messages_by_day[DATE][NICK] is an int
  eeps_by_day = defaultdict(lambda: defaultdict(int))
  ...
  #   if eeps_all_time[nick] < 30:
  #     drop_nicks.append(nick)
  # for drop_nick in drop_nicks:
  #   del eeps_all_time[drop_nick]
  ...
  args.summary_json_out.write(json.dumps({
    ...
    "eeps_all_time": eeps_all_time,
    "eeps_by_day": eeps_by_day
  }, indent=2))
